@extends('main')
@section('title', "Institutional Research - Faculty")
...
<div class="container body">
	<div class="row">
		<div class="col-lg-12">
			<div class="well">
				<h3 class="text-center">Institutional Researches by SMC Faculty</h3>
				<hr class="border">
				@if(count($posts) == 0)
				...
				<div class="row">
					...
					<div class="col-lg-2">
						<div class="form-group">
							<button class="btn btn-primary btn-block" onclick="searchJournals('Institutional Research', 'Faculty')"><i class="fa fa-search"></i> Search</button>
						</div>					
					</div>
				</div>
				<div id="posts">
