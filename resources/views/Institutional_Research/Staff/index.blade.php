...
<div class="container body">
	<div class="row">
		<div class="col-lg-12">
			<div class="well">
				<h3 class="text-center">Institutional Researches by SMC Staff</h3>
				<hr class="border">
				@if(count($posts) == 0)
				...
				<div class="row">
					...
					<div class="col-lg-2">
						<div class="form-group">
							<button class="btn btn-primary btn-block" onclick="searchJournals('Institutional Research', 'Staff')"><i class="fa fa-search"></i> Search</button>
						</div>					
					</div>
				</div>
				<div id="posts">
