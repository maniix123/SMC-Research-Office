@extends('admin')
@section('title', "Institutional Research - Staff")
@section('content')
<div class="content-wrapper">
	<section class="content">
		<ol class="breadcrumb">
			<li><a href="{{ url('Admin/Dashboard') }}"><i class="fa fa-home"></i> Home</a></li>
			<li><a href="#"><i class="fa fa-book"></i> Institutional Research</a></li>
			<li><a href="{{ url('Admin/Institutional-Research/Staff') }}"><i class="fa fa-users"></i> Staff</a></li>
		</ol>
		<div class="row">
			<div class="col-lg-8">
				<div class="well">
					...
					@endif
					<h3 class="text-center">Institutional Research by SMC Staff</h3>
					<hr class="border">
					@if(count($posts) == 0)
			...
			<div class="col-lg-4">
				<div class="well posts" style="padding: 19px;">
					...
					{{ Form::hidden('tab', 'Institutional Research') }}
					{{ Form::hidden('type', 'Staff') }}	
					<div class="form-group">				
						<button class="btn btn-primary" {{ (Auth::user()->type == 'Staff' || Auth::user()->role == 'Super Admin') ? "" : "disabled" }}><i class="fa fa-check"></i> Submit for review</button>	
					</div>
					{{ Form::close() }}
				</div>
			</div>
